...
string connStringERental = builder.Configuration.GetConnectionString("ERConnStr");

//OUR CODE    
builder.Services.AddDbContext<ApplicationDbContext>(options => options.UseSqlServer(connString));

builder.Services.AddDbContext<ERentalContext>(options => options.UseSqlServer(connStringERental));
...
if (app.Environment.IsDevelopment())
{
    app.UseSwagger();
    //app.UseSwaggerUI();
    app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "ASP.NET Core Web API v1"));    //added
}
...
app.UseEndpoints(endpoints =>                         //added
{
